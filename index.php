...
<body>
  ...
  <!-- <button type="button" id="modalButton" class="" data-toggle="modal" data-target="#myModal">
    Chat Now
  </button> -->
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h2 class="modal-title" id="myModalLabel">Hi There!</h2>
        </div>
        <div class="modal-body">
          <div class="col-sm-6">
            <img src="img/bob.png" class="img-circle">
          </div>
          <div class="col-sm-6">
            <h3>I'm Bob,</h3>
            <h3>Want to have a quick chat about our course?</h3>
            <a href="http://bobbrody.mybluemix.net/" target="_blank" target="_blank"><button class="btn bobButton">Live Chat Now</button></a>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="widget clearfix">
        	<div class="services_lists">
          	...
          	<div class="services_lists_boxes clearfix">
                ...
                <p>During the 16 week course, you'll be building a complete portfolio that will give your resume a huge boost when you're job searching.</p>
              </div>
            </div><!-- services_lists_boxes -->
          	<div class="services_lists_boxes clearfix">
            	<div class="col-lg-3 col-md-3 col-sm-12">
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 columns text-right">
        <div class="footer-menu right">
          <ul class="menu">
            ...
            <li>
              <a href="thecourses.php">The Course</a>
            </li>
            <li>
