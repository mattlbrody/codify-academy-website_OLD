...
// Menu
	$(".panel a").click(function(e){
		// e.preventDefault(); --- stopping a tags on thecourses.php to be clickable
...
function getUrl() {
	...
	if ( url.indexOf('index') > -1 ) {
		...
		$('a[href="thecourses.php"]').parent().addClass('active');
		...
		$('a[href="http://bobbrody.mybluemix.net/" target="_blank"]').parent().addClass('active');
